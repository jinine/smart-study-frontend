  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      ...
      <section className="text-center py-24 px-6 flex-1 flex flex-col justify-center">
        ...
        <Link
          to="/signup"
          className="bg-blue-600 text-white py-3 px-8 rounded-lg font-semibold shadow-md hover:bg-blue-700 transition"
        >
          Get Started
        </Link>
      </section>
      ...
      <section id="about" className="py-16 px-6 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <Link
            to="/about"
            className="bg-blue-600 text-white py-2 px-6 rounded-lg font-semibold shadow-md hover:bg-blue-700 transition"
          >
            Learn More
          </Link>
        </div>
